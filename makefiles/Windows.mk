...
lint: ## check style with flake8
	flake8 liverctsegmentationpackage tests
...
coverage: ## check code coverage quickly with the default Python
	coverage run --source liverctsegmentationpackage -m pytest
	coverage report -m
	coverage html
	$(BROWSER) htmlcov\index.html

docs: ## generate Sphinx HTML documentation, including API docs
	del /f /q docs\liverctsegmentationpackage.rst
	del /f /q docs\modules.rst
	sphinx-apidoc -o docs liverctsegmentationpackage
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
